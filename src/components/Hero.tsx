...
const Hero: React.FC = () => {
    const [activeVillage, setActiveVillage] =
        useState<string>("Усинск");
                ...
                <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-8 items-start">
                    ...
                    <div className="text-white pt-8 max-w-[620px]">
                        <h1 className="text-6xl leading-tight font-bold mb-8">
                            Добро пожаловать в цифровое пространство нашей культуры!
                        </h1>

                        <div className="space-y-5 text-lg text-gray-300 leading-relaxed">
                            <p>
                                Интерактивная платформа объединяет культурное наследие,
                                историю и традиции населённых пунктов Усинского района.
                            </p>
                            ...
                            <p>
                                Каждое село содержит отдельный раздел с материалами,
                                фотографиями, событиями и культурными объектами.
                            </p>
                        </div>
                        ...
                        <div className="mt-14">
                            <div className="max-w-2xl rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl p-8">
                                ...
                                <p className="text-gray-300 leading-relaxed">
                                    Нажмите на метку на карте или кнопку населённого пункта
                                    для перехода к материалам, событиям, фотографиям
                                    и культурным объектам выбранного раздела.
                                </p>
                            </div>
                        </div>
                    </div>
